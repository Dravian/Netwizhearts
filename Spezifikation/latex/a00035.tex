...
Es bietet alle Komponenten, um ein Regelwerk zu wählen, einen Spielnamen festzulegen und das Spiel durch ein Passwort zu schätzen. In der Spielerstellung wird ein Titelbild des ausgewählten Spiels und eine kurze Beschreibung angezeigt. über 'Leave' kehrt der Spieler in die \hyperlink{a00053}{Lobby} zurück und mit 'Create' wird das Spiel erstellt.
