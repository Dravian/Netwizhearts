...
description={Die Farbe die in der Partie am meisten Wert ist}}
...
\item \textbf{Paket Ruleset}
	\begin{itemize}
	\item \textbf{Server''NameOfTheGame''}: Dies ist eine Klasse, die die Einhaltung der Regeln garantiert. Serverseitig.
	\item \textbf{Client''NameOfTheGame''}: Dies ist eine Klasse, die eine Vorab-Regelauswertung vornehmen soll. Clientseitig.
	
	 Achten Sie bei der Entwicklung dieser Klassen darauf, dass die Methode isValidMove in beiden Klassen den selben Inhalt hat!
	\item \textbf{Color}: Eventuelle Änderungen in dieser Klasse, sollten andere Farben für das neue Regelwerk benötigt werden.
	\item \textbf{GamePhase}: Eventuelle Änderungen in dieser Klasse, sollten die bereits existierenden Phasen nicht ausreichen.
	...
	\item \textbf{RulesetType}: Änderungen an dieser Klasse, das Regelwerk muss hinzugefügt werden.
	\item \textbf{UserMessages}: 
	\end{itemize}
\end{itemize}
