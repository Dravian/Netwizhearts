...
\item \textbf{Ruleset(ServerHearts):} ang. Dauer: 30 Stunden, tats. Dauer: 13 Stunden
\end{itemize}

\subsection{Milestone 2}
\begin{itemize}
\item \textbf{View(Game):} ang. Dauer 20 Stunden, tats. Dauer: 16.5 Stunden
