...
\begin{itemize}
	...
	\item /F070/ Beitreten zu einem Spiel (Weiterleitung zum \gls{Wartefenster})
	\item /F080/ Erstellen einer neuen Spiels (Weiterleitung zum \gls{Erstellungsfenster})
	\item /F90/ Verlassen der \gls{Lobby}
\end{itemize}

\subsection{Erstellungsfenster}
\begin{itemize}
	\item /F120/ Auswahl des \gls{Regelwerk}s
	\item /F122/ Eingabe eines Namen für das Spiel
	\item /F124/ Erstellung abbrechen und \gls{Erstellungsfenster} verlassen
	\item /F126/ Erstellen eines neues Spiels
	\item /F130W/ Möglichkeit ein Passwort für das Spiel zu setzen
\end{itemize}

\subsection{Passwortabfrage}
\begin{itemize}
	\item /F140/ Eingabe eines Passworts
...
\begin{itemize}
	...
	\item /F185/ Starten des Spiels 
	\item /F187/ Verlassen des \gls{Wartefenster}s und des Spiels
	\item /F189/ Senden einer Nachricht an andere Spieler im \gls{Wartefenster}
...
\begin{itemize}
	...
	\item /F220/ Senden einer Nachricht an die Mitspieler
	\item /F230/ Auswählen einer Karte aus der eigenen Spielhand
	\item /F240/ Legen der Karte ??? -unnötig??
	\item /F245/ Verlassen des Spiels und damit Beendigung des Spiels mit Weiterleitung zur \gls{Lobby}
