...
\begin{itemize}
	...
	\item Server Lobby (Vorraussetzungen: erfolgreicher Login, aktive Serververbindung): \\ \\
	\begin{itemize}
	
		\item /T040/ \textit{Spielerliste:} Der eigene Benutzername "MrFancyPants" und die Benutzernamen aller anderen verbundenen Clients werden sofort in der Spielerliste angezeigt (/L100/).
		...
		\item /T080/ \textit{Spiel erstellen:} Mr. Orange erstellt ein Spiel und gelangt ins Erstellungsfenster (/F080/).
		
		\item /T090/ \textit{Spiel beitreten:} Mr. Blue tritt dem bereits korrekt geöffneten und noch nicht vollen Spiel von Mr. Orange bei und gelangt ins Wartefenster (/F070/).
