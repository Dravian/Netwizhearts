...
/**
 * GameServerRepresentation. Dies ist eine Klasse, die Informationen ueber den
 * Zustand eines Spielservers bereithaelt. Sie wird dem ComObjekt
 * ComLobbyUpdateGameList angehaengt, um die Spielliste in der GameLobby
...
public class GameServerRepresentation implements Serializable {
	 ...
	 *            der Name des Spiels
	 * @param max
	 *            Maximal moegliche Anzahl teilnehmender Spieler
	 * @param current
	 *            Anzahl momentaner Spieler
	 * @param type
	 *            Welches Ruleset verwendet wird
	 * @param password
