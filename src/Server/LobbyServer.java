...
public class LobbyServer extends Server {
	 ...
	 * 
	 * @param player ist der Spieler, der hinzugef�gt wird
	 * @param game ist das Spiel zu dem der Spieler hinzugef�gt wird
	 */
	...
	/**
	 * Getter f�r das Set der Spielernamen
	 * 
	 * @return Gibt das names Set zur�ck
	 */
