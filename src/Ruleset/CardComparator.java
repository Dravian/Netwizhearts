...
public class CardComparator implements Comparator<Card>{
	...
	public int compare(Card card1, Card card2) {
		...
		// Sortiert Hearts
		if(card1.getRuleset() == RulesetType.Hearts && card2.getRuleset() == RulesetType.Hearts) {
		...
		//Sortiert Wizard
		} else if(card1.getRuleset() == RulesetType.Wizard && card2.getRuleset() == RulesetType.Wizard) {
			...
			} else if(card1.getColour() == trumpColour && card2.getColour() == trumpColour) {
				if(card1.getValue() > card2.getValue()) {
					return 1;
