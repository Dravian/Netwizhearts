...
public enum HeartsCard implements Card{
	...
	HerzKoenig(13,Colour.HEART), HerzAss(12,Colour.HEART),
	...
	CaroKoenig(13,Colour.DIAMOND), CaroAss(12,Colour.DIAMOND),
	...
	KreuzKoenig(13,Colour.CLUB), KreuzAss(12,Colour.CLUB);
