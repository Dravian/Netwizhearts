...
public class TestClientWizardIsValidNumber {
	...
	public void test() {
		...
		testModel.giveInputNumber(4);
		assertTrue(((MsgNumber)((ComRuleset)testNetIO.getModelInput().get(0))
				.getRulesetMessage()).getNumber() == 4);
		testNetIO.getModelInput().clear();
		
		testModel.receiveMessage(new ComRuleset(new MsgNumberRequest()));	
		testModel.giveInputNumber(5);
